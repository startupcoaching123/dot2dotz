                        ...
                        <tr key={lead.leadId} className="hover:bg-blue-50/50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <span className={`px-2.5 py-1 rounded-md text-xs font-medium border
                              ...
                              {lead.leadStatus === 'BOOKED' ? 'PAYMENT ACCEPTED' : lead.leadStatus}
                            </span>
                          </td>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-2 space-y-1.5">
                      ...
                      <input name="pickupAddress" value={formData.pickupAddress} onChange={handleInputChange} placeholder="Plot 45, MIDC, Andheri East..." className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-gray-700">Timing Pref</label>
                      <input name="pickupPreferTiming" value={formData.pickupPreferTiming} onChange={handleInputChange} placeholder="Morning 8am-12pm" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input name="pickupContactPersonName" value={formData.pickupContactPersonName} onChange={handleInputChange} placeholder="Ramesh Sharma" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" />
                    </div>
                    <div className="space-y-1.5">
                      ...
                      <input name="pickupContactNo" value={formData.pickupContactNo} onChange={handleInputChange} placeholder="9876543210" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" maxLength={10} />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-2 space-y-1.5">
                      ...
                      <input name="dropAddress" value={formData.dropAddress} onChange={handleInputChange} placeholder="Near Sardar Patel Bridge..." className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input name="dropContactPersonName" value={formData.dropContactPersonName} onChange={handleInputChange} placeholder="Suresh Patel" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" />
                    </div>
                    <div className="space-y-1.5">
                      ...
                      <input name="dropContactNo" value={formData.dropContactNo} onChange={handleInputChange} placeholder="9123456780" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" maxLength={10} />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        ...
                        <input name="consignmentType" value={formData.consignmentType} onChange={handleInputChange} placeholder="e.g., Industrial Goods, Pharma..." className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-sm font-medium text-gray-700">Gross Weight (kg)</label>
                        <input name="consignmentGrossWeight" value={formData.consignmentGrossWeight} onChange={handleInputChange} placeholder="12000" className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors" />
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
              ...
              <div className="p-6 border-b border-gray-200 flex justify-between items-center bg-gray-50">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">Lead Details #{selectedLead.leadId}</h3>
                    <div className="flex items-center gap-3 mt-1">
                      <span className={`px-2.5 py-0.5 rounded-md text-xs font-medium border ${
                        selectedLead.leadStatus === 'GENERATED' ? 'bg-blue-50 text-blue-700 border-blue-200' : 
                        selectedLead.leadStatus === 'BOOKED' ? 'bg-emerald-50 text-emerald-700 border-emerald-200' :
                        'bg-green-50 text-green-700 border-green-200'
                      }`}>
                        {selectedLead.leadStatus === 'BOOKED' ? 'PAYMENT ACCEPTED' : selectedLead.leadStatus}
                      </span>
                      <p className="text-xs text-gray-500">{new Date(selectedLead.requestedOn).toLocaleDateString()}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-8">
                    <div className="space-y-4">
                      ...
                      <div className="relative pl-6 space-y-6 border-l-2 border-dashed border-gray-200 ml-2">
                        <div className="relative">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-semibold text-gray-900">{selectedLead.pickupCity}, {selectedLead.pickupState}</p>
                            <p className="text-xs text-gray-600 mt-1">{selectedLead.pickupAddress} — {selectedLead.pickupFromPincode}</p>
                          </div>
                        </div>
                        <div className="relative">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-semibold text-gray-900">{selectedLead.dropCity}, {selectedLead.dropState}</p>
                            <p className="text-xs text-gray-600 mt-1">{selectedLead.dropAddress} — {selectedLead.dropToPincode}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <p className="text-sm font-medium text-gray-900">{selectedLead.pickupPreferTiming || 'Standard working hours'}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                          ...
                          <p className="text-sm font-semibold text-gray-900">{selectedLead.consignmentType}</p>
                        </div>
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                          <p className="text-xs font-medium text-gray-500 mb-1">Weight</p>
                          <p className="text-sm font-semibold text-gray-900">{selectedLead.consignmentGrossWeight} <span className="text-xs font-normal text-gray-500">KG</span></p>
                        </div>
                        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 col-span-2 flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm font-semibold text-blue-900">{selectedLead.vehicle} <span className="text-blue-600 font-normal text-sm ml-1">({selectedLead.vehicleType})</span></p>
                          </div>
                          ...
                          {leadQuotes.map((quote) => (
                            <div key={quote.leadMatchId} className="p-4 bg-white border border-gray-200 rounded-lg hover:border-indigo-300 hover:shadow-sm transition-all">
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <button
                                  onClick={() => {
                                    if (selectedLead.leadStatus === 'LEADACCEPTED') {
                                      handleInitiatePayment(selectedLead.leadId);
                                    } else {
                                      handleAcceptQuote(quote);
                                    }
                                  }}
                                  disabled={isAccepting || selectedLead.leadStatus === 'BOOKED'}
                                  className={`w-full sm:w-auto px-5 py-2.5 rounded-lg font-medium text-sm transition-colors ${
                                      selectedLead.leadStatus === 'BOOKED'
